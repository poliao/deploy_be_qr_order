              ...
              <div className='grid justify-stretch'>
                  ...
                  <div className='justify-self-center'>
                     <div>
                       ...
                       <div className='sm:text-2xl mt-3 font-bold text-white flex items-center px-8 py-2 rounded-md' style={{backgroundColor: "#73A53A"} }>+ เพิ่มเมนู</div>
                     </div>
                  </div>
              </div>
              </div>
       ...
       <div className='flex'> 
        ...
        <div className='m-6 bg-white w-full rounded-md p-6'>
          <div className='sm:flex hidden  justify-between'>
            ...
            <div className='sm:text-xl font-bold text-white flex items-center px-8 rounded-md' style={{backgroundColor: "#73A53A"} }>+ เพิ่มเมนู</div>
            </div>
